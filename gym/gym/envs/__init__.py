...
register(
    id='AntUp-v1',
    entry_point='gym.envs.mujoco:AntUpEnv',
    max_episode_steps=1000,
    reward_threshold=6000.0,
)
...
register(
    id='AntDown-v1',
    entry_point='gym.envs.mujoco:AntDownEnv',
    max_episode_steps=1000,
    reward_threshold=6000.0,
)
...
register(
    id='AntLeft-v1',
    entry_point='gym.envs.mujoco:AntLeftEnv',
    max_episode_steps=1000,
    reward_threshold=6000.0,
)
...
register(
    id='AntRight-v1',
    entry_point='gym.envs.mujoco:AntRightEnv',
    max_episode_steps=1000,
    reward_threshold=6000.0,
)
